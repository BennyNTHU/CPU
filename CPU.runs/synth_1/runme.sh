...
HD_PWD='C:/Users/benny/Saved Games/CPU/CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_V_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_V_CPU.tcl
